...
__all__ = ["SalesforcePlugin", "__version__"]
__version__ = "0.0.1"
...
@patch("airflow.plugins_manager", plugins_manager, create=True)
@patch.dict("sys.modules", {"airflow.plugins_manager": plugins_manager})
def patch_airflow():
    import airflow
    ...
    if PATCHED_AIRFLOW:
        return
    plugins: List[airflow.plugins_manager.AirflowPlugin] = plugins_manager.plugins

    plugins = plugins_manager.load_entrypoint_plugins(
